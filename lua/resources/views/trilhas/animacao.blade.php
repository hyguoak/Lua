        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  ...
                  <div class="d-flex justify-content-between">
                    <p>HISTÓRIA DO DESIGN</p>
                    <p>64H</p>
                  </div>
                  <div class="d-flex justify-content-between">
                    <p>INTRODUÇÃO A SISTEMAS E MÍDIAS DIGITAIS</p>
                    <p>64H</p>
                  </div>
                  <div class="d-flex justify-content-between">
                    <p>PROGRAMAÇÃO I</p>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <div class="d-flex justify-content-between">
                      <p>COGNIÇÃO E TECNOLOGIAS DIGITAIS</p>
                      <p>64H</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p>COMUNICAÇÃO VISUAL I</p>
                      <p>64H</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p>MATEMÁTICA APLICADA À MULTIMÍDIA I</p>
                      <p>64H</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p>NARRATIVAS MULTIMÍDIA</p>
                      <p>64H</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p>PROGRAMAÇÃO II</p>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <div class="d-flex justify-content-between">
                      <p>AUTORAÇÃO MULTIMÍDIA II</p>
                      <p>64H</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p>DESIGN DE INTERFACES GRÁFICAS</p>
                      <p>64H</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p>INTERAÇÃO HUMANO-COMPUTADOR I</p>
                      <p>64H</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p>INTRODUÇÃO À CIBERCULTURA</p>
                      <p>64H</p>
                    </div>
                    <div class="d-flex justify-content-between">
                      <p>PROJETO INTEGRADO I</p>
                      <p>64H</p>
                    </div>
